...
(function () {
    ...
    function preloadImages(centerIndex) {
        for (let offset = -1; offset <= preloadRange; offset++) {
            ...
            } else if (img && img.classList.contains('loaded') && idx === currentIndex) {
                hideLoader();
            }
        }
    }
    ...
    function bindEvents() {
        ...
        slideViewport.addEventListener('touchstart', handleTouchStart, { passive: true });
